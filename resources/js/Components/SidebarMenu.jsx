            ...
            <li>
                <div>
                    <button
                        ...
                        className={`item-menu  cursor-pointer focus:ring-2 focus:ring-blue-200 text-slate-700 transition-all group py-2 px-3 rounded-md  flex items-center gap-1 ${active ? 'text-slate-50 font-medium bg-blue-600 hover:bg-blue-600 border-b-2 backdrop-blur border-b-blue-700' : 'hover:bg-blue-50'} group w-full`}>
                        <div
